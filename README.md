...
> **Nota:** Não testamos mais via Postman manualmente. Todos os fluxos críticos da aplicação são validados de forma automatizada através dos nossos **testes E2E rodando no Cypress**!

A suíte de testes E2E do projeto cobre **100% dos fluxos críticos**, garantindo a qualidade da aplicação de ponta a ponta (Frontend e Backend). 
Para rodar os testes localmente ou entender a arquitetura da suíte e os logs detalhados, acesse a documentação do módulo de testes no repositório correspondente:

👉 **[Acessar a Documentação de Testes UI](./teste%20UI/README.md)**
